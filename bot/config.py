...
CONFIDENCE_CAP = 80  # Cap raw confidence to prevent late-entry false consensus
...
COUNTER_TREND_PENALTY = {
    "TREND_UP": 0.68,           # SHORT signals: only raw ≥99% pass (100×0.8×0.68=54.4)
    "TREND_DOWN": 0.68,         # LONG signals: only raw ≥99% pass
