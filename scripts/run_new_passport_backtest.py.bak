...
if __name__ == "__main__":
    ...
    print(f"🚀 New Passport Backtest — {args.days}d window, {args.pairs} pairs")
    print(f"📁 Log: {logfile}\n")

    results = run_all(args.days, args.pairs)
